...
![example event parameter](https://github.com/OpenSourceEcon/usempl_plots/actions/workflows/build_and_test.yml/badge.svg)
![example event parameter](https://github.com/OpenSourceEcon/usempl_plots/actions/workflows/check_black.yml/badge.svg)
[![codecov](https://codecov.io/gh/OpenSourceEcon/usempl_plots/branch/master/graph/badge.svg)](https://codecov.io/gh/OpenSourceEcon/usempl_plots)
...
* Browse the repository [Issues](https://github.com/OpenSourceEcon/usempl_plots/issues) for known areas that need attention.
* Submit questions or suggestions by submitting a new issue in the repository [Issues](https://github.com/OpenSourceEcon/usempl_plots/issues).
